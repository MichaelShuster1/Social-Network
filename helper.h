...
void printAllRegisteredEntitiesInSystem(const System& system); //prints all the registered entities in system
...
void printAllFriendsOrFansEntity(const System& system); //prints all friends or fans of the system
...
void showAllStatusesOfAFanPageOrMember(const System& system);//shows all statuses of a given page or mebmer in system
void ShowTenStatusesOfEachFriend(const System& system); //Shows all the last 10 statuses of the user's friends
...
void chooseStatusType(int& choice); // choose the type of the status (text, picture or video)
